...
var bigBtnTxt = "flex text-3xl py-4 items-center justify-center is-fullwidth w-full text-center py-2 px-4 rounded-md border hover:bg-opacity-75 focus:outline-none mt-2 mb-2"
