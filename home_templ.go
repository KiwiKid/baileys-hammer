...
func home(players []PlayerWithFines, approvedPFines []PresetFine, pendingPFines []PresetFine, fineWithPlayers []FineWithPlayer, qp HomeQueryParams, activeMatch *Match) templ.Component {
	return templ.ComponentFunc(func(ctx context.Context, w io.Writer) (err error) {
		...
		_, err = templBuffer.WriteString("\" id=\"leaderboard\"><div class=\"w-full\"><div id=\"swipeArea\" class=\"swipe-area w-full\"><h3 class=\"text-2xl font-bold text-center\" hx-trigger=\"dblclick\" hx-get=\"/match-list\" hx-push-url=\"true\">")
		if err != nil {
			return err
		}
		var_43 := `Leaderboard`
